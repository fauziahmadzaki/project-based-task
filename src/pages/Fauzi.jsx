        ...
        <div className="px-8 pb-10 sm:px-12">
          ...
          <div className="relative flex flex-col sm:flex-row items-center sm:items-end gap-6 -mt-24 mb-10">
            <div className="relative group">
              ...
              <img
                className="w-36 h-36 rounded-full border-[5px] border-slate-900 bg-slate-800 flex items-center justify-center text-4xl font-black bg-gradient-to-br from-indigo-500 to-fuchsia-500 text-white shadow-xl relative z-10 text-center shrink-0 tracking-wider"
                src="/fauzi.jpg"
              />
            </div>
            ...
            <div className="flex gap-3 mb-2">
              <a
                href="https://github.com/fauziahmadzaki"
                className="p-3 bg-white/5 hover:bg-white/10 rounded-full text-slate-300 transition-colors border border-white/10 group"
              >
                <svg
              ...
              <a
                href="https://instagram.com/fauziahmadzaki7"
                className="p-3 bg-white/5 hover:bg-white/10 rounded-full text-slate-300 transition-colors border border-white/10 group"
              >
                <svg
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div className="space-y-6 flex flex-col md:col-span-2 justify-start">
              <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 hover:bg-white/[0.05] transition-colors">
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-center gap-4 text-slate-300 text-sm">
                    ...
                    <span className="">
                      NIM: <span className="text-sm">253140700111001</span>
                    </span>
                  </li>
                  <li className="flex items-center gap-4 text-slate-300 text-sm">
              ...
              <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 hover:bg-white/[0.05] transition-colors">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={index}
                      className="px-3 py-1.5 bg-white-5 border border-white/10 rounded-lg text-xs font-medium text-slate-300 hover:border-indigo-500/50 hover:bg-indigo-500/10 hover:text-indigo-300 transition-all cursor-default"
                    >
                      {skill}
                    </span>
                  ))}
              ...
              <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-8 relative overflow-hidden group h-full hover:bg-white/[0.05] transition-colors">
                ...
                <div className="space-y-5 text-slate-300/90 leading-relaxed font-light">
                  <p>
                    ...
                    , seorang mahasiswa dengan ketertarikan mendalam pada
                    pengembangan web. Saya senang membangun antarmuka pengguna
                    yang indah, interaktif, dan modern, dengan selalu
                    mengedepankan pengalaman serta estetika.
                  </p>
                  <p>
                    Saya menguasai berbagai teknologi front-end modern seperti{" "}
                    <span className="text-indigo-400">React</span>,{" "}
                    <span className="text-indigo-400">Tailwind CSS</span>, dan{" "}
                    <span className="text-indigo-400">Next.js</span>. Selalu
                    antusias mempelajari tren desain terbaru dan berusaha
                    mengimplementasikannya dalam setiap karya saya, memastikan
                    setiap baris kode yang ditulis tidak hanya berfungsi dengan
                    baik, tetapi juga terlihat luar biasa.
                  </p>
                  <p>
                    Selain coding, saya memiliki minat pada desain UI/UX dan
                    suka mengeksplorasi cara-cara baru untuk membuat website
                    yang terasa hidup. Bergabung dengan komunitas dan belajar
                    hal baru adalah hal yang sangat saya nikmati!
                  </p>
                </div>

                <div className="mt-8 pt-6 border-t border-white/10">
                  <p className="text-indigo-400/80 font-medium italic text-lg text-center font-serif">
                    "Menciptakan pengalaman digital yang luar biasa, satu baris
                    kode setiap saat."
                  </p>
                </div>
              </div>
